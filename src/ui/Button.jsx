...
const Button = ({ children, disabled, to, type, onClick }) => {
  ...
  const styles = {
    primary: baseClassName + ' px-4 py-3 md:px-6 md:py-4',
    small: baseClassName + ' px-4 py-2 md:px-5 md:py-2.5 text-xs',
    round: baseClassName + ' px-2.5 py-1 md:px-3.5 md:py-2 text-sm',
    secondary:
